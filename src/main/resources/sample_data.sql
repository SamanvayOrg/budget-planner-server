...
(name,state_id, function_id, detailed_head_id, display_order)
    (select name,1, function_id, detailed_head_id, display_order
     from budget_line
     where budget_id = 1);
...
insert into sample_budget_line(id,name, state_id, function_id, detailed_head_id, display_order)values (1,(select name from function where full_code='910'),1, (select id from function where full_code = '910'), (select id from detailed_head where full_code = '1110'), 1);
insert into sample_budget_line(id,name, state_id, function_id, detailed_head_id, display_order)values (2,(select name from function where full_code='910'),1, (select id from function where full_code = '910'), (select id from detailed_head where full_code = '1111'), 2);
insert into sample_budget_line(id,name, state_id, function_id, detailed_head_id, display_order)values (3,(select name from function where full_code='920'),1, (select id from function where full_code = '920'), (select id from detailed_head where full_code = '1120'), 3);
insert into sample_budget_line(id,name, state_id, function_id, detailed_head_id, display_order)values (4,(select name from function where full_code='920'),1, (select id from function where full_code = '920'), (select id from detailed_head where full_code = '1121'), 4);
insert into sample_budget_line(id,name, state_id, function_id, detailed_head_id, display_order)values (5,(select name from function where full_code='310'),1, (select id from function where full_code = '310'), (select id from detailed_head where full_code = '2510'), 5);
insert into sample_budget_line(id,name, state_id, function_id, detailed_head_id, display_order)values (6,(select name from function where full_code='314'),1, (select id from function where full_code = '314'), (select id from detailed_head where full_code = '2520'), 6);
insert into sample_budget_line(id,name, state_id, function_id, detailed_head_id, display_order)values (7,(select name from function where full_code='210'),1, (select id from function where full_code = '210'), (select id from detailed_head where full_code = '3221'), 7);
insert into sample_budget_line(id,name, state_id, function_id, detailed_head_id, display_order)values (8,(select name from function where full_code='315'),1, (select id from function where full_code = '315'), (select id from detailed_head where full_code = '4234'), 8);
insert into sample_budget_line(id,name, state_id, function_id, detailed_head_id, display_order)values (9,(select name from function where full_code='740'),1, (select id from function where full_code = '740'), (select id from detailed_head where full_code = '3230'), 9);
